...
try {
    ...
    if ($isAdmin) {
        ...
        $stmt = $db->prepare("SELECT * FROM user_manual WHERE is_active = 1 ORDER BY display_order ASC");
        $stmt->execute();
    } else {
        // Other roles see only their role's items + shared items (role='')
        $stmt = $db->prepare("SELECT * FROM user_manual WHERE is_active = 1 AND (role = :role OR role = '') ORDER BY display_order ASC");
            ...
            <div class="manual-layout">
                ...
                <div class="manual-main">
                    ...
                    <div id="manualContainer">
                        <!-- 1. Role Map -->
                        <section id="manual-role-map" class="manual-section reveal-on-scroll" data-section data-role="all" data-category="overview" data-content="Role Map ผู้ประกอบการ กรรมการ ผู้ดูแลระบบ">
                            <h2>
                        ...
                        <!-- 2. Project Structure -->
                        <section id="manual-project-structure" class="manual-section reveal-on-scroll" data-section data-role="admin" data-category="overview" data-content="โครงสร้างโปรเจค โฟลเดอร์ api config database includes pages scripts">
                            <h2>
...
└── <span class="file">index.php</span>          <span class="count">← Entry Point</span></pre>
                        ...
                        <!-- 3. User Flow Diagram -->
                        <section id="manual-flow" class="manual-section reveal-on-scroll" data-section data-role="all" data-category="overview" data-content="Flow การใช้งาน User Flow diagram">
                            <h2>
...
flowchart TB
    ...
    D1 --> D2[Leaderboard]
                        ...
                        <!-- 4. Database Schema -->
                        <section id="manual-database" class="manual-section reveal-on-scroll" data-section data-role="admin" data-category="overview" data-content="โครงสร้างฐานข้อมูล Database Schema tables">
                            <h2>
                        ...
                        <!-- 5. API Endpoints -->
                        <section id="manual-api" class="manual-section reveal-on-scroll" data-section data-role="admin" data-category="overview" data-content="API Endpoints upload download save assessment">
                            <h2>
                        ...
                        <!-- 6. Scoring Formula -->
                        <section id="manual-formulas" class="manual-section reveal-on-scroll" data-section data-role="admin" data-category="overview" data-content="formulas สูตรการคำนวณ คะแนน Pillar H1 I2 C3 M4">
                            <h2>
                                <svg width="32" height="32" class="text-primary-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <section id="manual-pillars" class="manual-section reveal-on-scroll" data-section data-role="all" data-category="overview" data-content="4 Pillars H1 I2 C3 M4 โครงสร้างน้ำหนัก ระดับคะแนน HICM">
                            <h2>
                        ...
                        <!-- 8. Personas -->
                        <section id="manual-personas" class="manual-section reveal-on-scroll" data-section data-role="all" data-category="usage" data-content="ตัวละคร Persona Admin Auditor Company CEO โปรไฟล์">
                            <h2>
                        ...
                        <!-- 9. Status Flow -->
                        <section id="manual-status" class="manual-section reveal-on-scroll" data-section data-role="all" data-category="usage" data-content="สถานะการประเมิน draft submitted under_review evaluated completed">
                            <h2>
...
stateDiagram-v2
    ...
    evaluated --> completed: Admin อนุมัติ
                        ...
                        <!-- 10. Steps: Company -->
                        <section id="manual-steps-company" class="manual-section reveal-on-scroll" data-section data-role="company" data-category="usage" data-content="ขั้นตอนผู้ประกอบการ Company กรอกแบบประเมิน แนบหลักฐาน">
                            <h2>
                        ...
                        <!-- 11. Steps: Auditor -->
                        <section id="manual-steps-auditor" class="manual-section reveal-on-scroll" data-section data-role="auditor" data-category="usage" data-content="ขั้นตอนกรรมการ Auditor ประเมิน ให้คะแนน ตรวจหลักฐาน">
                            <h2>
                        ...
                        <!-- 12. Steps: Admin -->
                        <section id="manual-steps-admin" class="manual-section reveal-on-scroll" data-section data-role="admin" data-category="usage" data-content="ขั้นตอน Admin ผู้ดูแลระบบ จัดการผู้ใช้ ตั้งค่า">
                            <h2>
                        ...
                        <!-- 13. Steps: CEO -->
                        <section id="manual-steps-ceo" class="manual-section reveal-on-scroll" data-section data-role="ceo" data-category="usage" data-content="ขั้นตอน CEO ผู้บริหาร ดูรายงาน Leaderboard สรุปผล">
                            <h2>
